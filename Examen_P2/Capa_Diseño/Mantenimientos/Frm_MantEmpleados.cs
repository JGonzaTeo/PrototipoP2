...
{
    public partial class Frm_MantEmpleados : Form
    {
        Logica logic = new Logica();
        string scampo;
        public Frm_MantEmpleados()
        {
            InitializeComponent();
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { textBox1, textBox2, textBox3 }; //COLOCAR TODOS LOS TEXTBOX QUE SE UTILZIARAN
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "prueba", textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.Text };
                string[] campos = { "COD", "edad", "nombre", "estado" };
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "prueb", textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.Text };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "prueba", textBox1.Text, "COD" };
