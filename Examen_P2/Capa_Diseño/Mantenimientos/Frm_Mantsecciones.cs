...
{
    public partial class Frm_Mantsecciones : Form
    {

        Logica logic = new Logica();
        string scampo;
        public Frm_Mantsecciones()
        {
            InitializeComponent();
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "secciones", Txt_Codigo.Text, Txt_nombre.Text, Cbo_estado.Text };
                string[] campos = { "codigo_seccion", "nombre_seccion", "estatus_seccion" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "secciones", Txt_Codigo.Text, "codigo_seccion" };
